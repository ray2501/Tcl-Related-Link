...
* [AOLserver](https://sourceforge.net/projects/aolserver/)
* [NaviServer](https://sourceforge.net/projects/naviserver/),
and [qcode-tcl](https://github.com/qcode-software/qcode-tcl)
* [OpenACS](https://openacs.org/)
* [Apache Rivet](https://tcl.apache.org/rivet/), 3.0.0 provide support for
...
* [tclhttpd](https://core.tcl-lang.org/tclhttpd/index)
...
[Wiki page](https://wiki.tcl-lang.org/page/Wibble)
* [Wub](https://github.com/tcler/wub) (github clone) and [Wiki page](https://wiki.tcl-lang.org/page/Wub)
...
* [Wapp](https://wapp.tcl.tk/home/doc/trunk/README.md) - A Web-Application Framework for TCL
 ...
 * [DustMote](https://wiki.tcl-lang.org/page/DustMote) - A web server in one page of Tcl code
 ...
 * [tmpl_parser](https://wiki.tcl-lang.org/page/tmpl%5Fparser) - a simple and fast template engine
 * [TemplaTcl: a Tcl template engine](https://wiki.tcl-lang.org/page/TemplaTcl%3A+a+Tcl+template+engine)
 * [GraphQL with Tcl](https://wiki.tcl-lang.org/page/GraphQL)
 * [webpage-1.0](https://wiki.tcl-lang.org/page/Webpage+1%2E0+%2D+Web+page+macro+facility) -
A pure TCL extension package for generating HTML pages
 * [WubWikit](https://wiki.tcl-lang.org/page/WubWikit) - wubwikit bundles together Wub and wikit
 * [tclhttpd Generic Caching](https://wiki.tcl-lang.org/page/tclhttpd+Generic+Caching)
